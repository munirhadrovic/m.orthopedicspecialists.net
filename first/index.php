...
<html>
	<head>
		<title>Our goal is to provide the very best care for our patients.</title>
	...
	<body>
        ...
        <div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
            <h1 style="font-weight: normal; font-size: 13px;">Powered By <a href="http://mobilegrows.com/" rel="external" style="text-decoration: none;">MobileGrows</a> | <a href="http://www.orthopedicspecialists.net/" rel="external" style="text-decoration: none;">  Desktop Site</a></h1>
        </div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-home ui-btn-icon-left buttons-radius" href="#ourteam" data-transition="<?php echo $transitionefect ?>">Home</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#ourteam" data-transition="<?php echo $transitionefect ?>">About Us</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#ourteam" data-transition="<?php echo $transitionefect ?>">Our Physicians</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#ourteam" data-transition="<?php echo $transitionefect ?>">Scope of Services</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#ourteam" data-transition="<?php echo $transitionefect ?>">Patient Center</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#ourteam" data-transition="<?php echo $transitionefect ?>">In the news</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#ourteam" data-transition="<?php echo $transitionefect ?>">Patient Education</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#ourteam" data-transition="<?php echo $transitionefect ?>">Online Forms</a></div>
				</div>	
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#patientinfo" data-transition="<?php echo $transitionefect ?>">Español</a></div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
	...
	<!-- page home ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		...
		<div id="contactform" data-role="page" data-theme="<?php echo $theme ?>">
			<div data-role="main" class="ui-content anes" >
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
		...
		<div id="ourteam" data-role="page" data-theme="<?php echo $theme ?>">
			<div data-role="main" class="ui-content" >
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                    ...
                    <p class="pad">This is only a <strong>preview</strong> version of your Mobile Website.<br>
		...
		<div id="patientinfo" data-role="page" data-theme="<?php echo $theme ?>">
			<div data-role="main" class="ui-content" >
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					...
					<p class="pad"> Este es sólo un <strong> vista previa </strong> versión de su sitio web móvil.<br>
                        Por favor, póngase en contacto con nuestro oficial Represcutative ventas de <strong> Full Funcional Versión. </strong></p>
				</div>
			</div>
